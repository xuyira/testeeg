...
if __name__ == "__main__":
    ...
    print("加载数据...")
    x_fake_np  = np.load('../datasets/eegdata/bci2a/resub1234567/train_data.npy')
    x_real1_np = np.load('../datasets/eegdata/bci2a/resub1234567/test_data.npy')
    x_real2_np = np.load('../datasets/eegdata/bci2a/resub8/test_data.npy')
